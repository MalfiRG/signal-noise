...
- **Storage & Destinations** (where data goes)
...
Start with the total — say, 68 cases. Subtract 22 cases that are blocked on UI access (1-2 days when unblocked). That leaves 46. Subtract 4 cases needing complex storage setup (1 day). 42 remaining. Subtract 7 immutability cases across 3 repo types (3 days, roughly 1 per type). 35 remaining. And so on.
