...
<!-- STUB: Describe the Playwright-in-WSL2 setup (extracted .deb libs, LD_LIBRARY_PATH hack), the screenshot scripts, the breakpoint matrix (29 viewports), and the visual inspection workflow. Mention the Veeam scrub check as a recurring audit. -->
...
- Veeam references: scrubbed from about/data.ts and skills/data.ts
