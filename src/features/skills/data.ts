...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    level: 85,
    description:
      "Bread and butter. Designing and executeing comprehensive test suites for RESTful APIs. Utilizing tools like Postman, Newman, Pytest to automate what can and should be automated.",
  },
  {
  ...
  },
  {
    ...
    level: 75,
    description:
      "Test automation, scripting, REST API testing, data processing. Architecting whole programs from scratch with AI assistance comfortably. No worries, I am taking care to gitignore .venv and .env ;)",
  },
  {
