        ...
        return (
          <div key={cat} role="treeitem" aria-expanded={isExpanded}>
            <button
              ...
              className="flex items-center gap-1 w-full px-2 py-1.5 text-base tracking-wider text-primary/90 hover:text-primary transition-colors font-medium"
            >
              <ChevronRight
                className={`h-3.5 w-3.5 transition-transform text-muted-foreground ${isExpanded ? "rotate-90" : ""}`}
              />
                  ...
                  {postsByCategory[cat].map((post) => {
                    ...
                    return (
                      <Link
                        ...
                        className={`flex items-center gap-1.5 px-2 py-1.5 pl-7 text-base tracking-wider transition-colors hover:text-primary ${
                          isDimmed
